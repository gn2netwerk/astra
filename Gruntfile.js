        ...
        cssmin: {
            ...
            css: {
                files: [
                    ...
                    {
                        src: 'assets/css/unminified/compatibility/edd-grid-rtl.css',
                        dest: 'assets/css/minified/compatibility/edd-grid.min-rtl.css',
                    },
                    {
        ...
        copy: {
            main: {
                ...
                src: [
					...
					'!admin/assets/theme-builder/src/**',
					'!admin/assets/theme-builder/package.json',
					'!admin/assets/theme-builder/package-lock.json',
					'!admin/assets/theme-builder/webpack.config.js',
					'!playwright-report/**',
