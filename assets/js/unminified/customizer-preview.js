...
( function( $ ) {
	...
	wp.customize( 'astra-settings[secondary-theme-button-border-group-border-size]', function( value ) {
		value.bind( function( border ) {
			...
			var dynamicStyle = '.wp-block-button.is-style-outline .wp-block-button__link, .ast-outline-button';
	...
	astra_responsive_spacing( 'astra-settings[secondary-theme-button-padding]','.wp-block-button.is-style-outline .wp-block-button__link, .ast-outline-button', 'padding', [ 'top', 'bottom' ] );

	astra_responsive_spacing( 'astra-settings[secondary-theme-button-padding]','.wp-block-button.is-style-outline .wp-block-button__link, .ast-outline-button', 'padding', [ 'left', 'right' ] );
	...
	if ( astraCustomizer.page_builder_button_style_css ) {
		...
		astra_css( 'astra-settings[secondary-theme-button-border-group-border-color]', 'border-color', '.wp-block-button.is-style-outline .wp-block-button__link, .ast-outline-button' );
	...
	function astraHandleButtonPresetPreview( btnSelector ) {
				...
				if( 'button_04' === value || 'button_05' === value || 'button_06' === value ) {
					...
					if( '' === buttonBorderColor ) {
						...
						jQuery( 'head' ).append(
							...
							+ btnSecondaryColorSelector + '	{ border-color: ' + buttonBGColor + ' }'
							+ '</style>'
						);
					}
					...
					jQuery( 'head' ).append(
						...
						+ btnSecondaryColorSelector + '	{ background: transparent }'
						+ '</style>'
					);
				} else {
		...
		const btnSecondaryBgSelector = 'div.wp-block-button.is-style-outline > .wp-block-button__link:not(.has-background-color), div.wp-block-button.wp-block-button__link.is-style-outline:not(.has-background-color)';
			...
			setting.bind( function( value ) {
				...
				if( 'button_04' === buttonPreset || 'button_05' === buttonPreset || 'button_06' === buttonPreset ) {
					...
					if( '' === buttonTextColor ) {
						...
						jQuery( 'head' ).append(
							'<style id="astra-settings-secondary-button-outline-preset-color">'
							+ btnSecondaryBgSelector + '	{ color: #FFFFFF; }'
							+ '</style>'
						);
					}
					...
					jQuery( 'head' ).append(
						...
						+ btnSecondaryBgSelector + '	{ background-color: ' + value + ' }'
						+ '</style>'
					);
				}
			} );
