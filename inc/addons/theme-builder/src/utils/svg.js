const iconSVG = {
	...
	Hooks: (
		...
		>
			<rect x="0.5" width="323.5" height="304" rx="5" fill="#ECEFF3" />
			<rect x="49.25" y="50.5" width="226" height="103" rx="5" fill="#D6DCE4" />
			<path
			...
			/>
			<rect x="49.25" y="173.5" width="226" height="8" rx="4" fill="#D6DCE4" />
			<rect x="49.25" y="191.5" width="226" height="8" rx="4" fill="#D6DCE4" />
			<rect x="49.25" y="209.5" width="226" height="8" rx="4" fill="#D6DCE4" />
			<rect x="49.25" y="227.5" width="226" height="8" rx="4" fill="#D6DCE4" />
			<rect x="49.25" y="245.5" width="154" height="8" rx="4" fill="#D6DCE4" />
		</svg>
	),
	Archive: (
		<svg
	...
	Single: (
		...
		>
			...
			<rect x="49.25" y="30" width="25" height="25" rx="12.5" fill="#D6DCE4" />
