...
// 		$theme_options['site-content-style'] = 'unboxed';
// 		switch ( $old_layout ) {
// 			case 'boxed-container':
// 				$theme_options['new-site-content-layout'] = 'normal-width-container';
// 				$theme_options['site-content-style']      = 'boxed';
// 				break;
...
// 				break;
// 			case 'page-builder':
// 				$theme_options['new-site-content-layout'] = 'full-width-container';
// 				break;
// 			case 'narrow-container':
// 				$theme_options['new-site-content-layout'] = 'narrow-width-container';
// 				break;
// 			default:
// 				break;
// 		}
...
// 		$post_types = Astra_Posts_Structure_Loader::get_supported_post_types();
// 		foreach( $post_types as $index => $post_type ) {
// 			$old_layout = $theme_options['single-' . esc_attr($post_type) . '-content-layout'];
// 			switch ( $old_layout ) {
// 				case 'boxed-container':
// 					$theme_options['single-' . esc_attr($post_type) . '-new-content-layout'] = 'normal-width-container';
// 					$theme_options['single-' . esc_attr($post_type) . '-content-style']      = 'boxed';
// 					break;
// 				case 'content-boxed-container':
// 					$theme_options['single-' . esc_attr($post_type) . '-new-content-layout'] = 'normal-width-container';
// 					$theme_options['single-' . esc_attr($post_type) . '-content-style']      = 'boxed';
...
// 				case 'plain-container':
// 					$theme_options['single-' . esc_attr($post_type) . '-new-content-layout'] = 'normal-width-container';
// 					$theme_options['single-' . esc_attr($post_type) . '-content-style']      = 'unboxed';
// 					break;
// 				case 'page-builder':
// 					$theme_options['single-' . esc_attr($post_type) . '-new-content-layout'] = 'full-width-container';
// 					$theme_options['single-' . esc_attr($post_type) . '-content-style']      = 'unboxed';
// 					break;
// 				case 'narrow-container':
// 					$theme_options['single-' . esc_attr($post_type) . '-new-content-layout'] = 'narrow-width-container';
// 					$theme_options['single-' . esc_attr($post_type) . '-content-style']      = 'unboxed';
// 					break;
// 				default:
// 					$theme_options['single-' . esc_attr($post_type) . '-new-content-layout'] = 'default';
// 					$theme_options['single-' . esc_attr($post_type) . '-content-style']      = 'default';
// 					break;
// 			}
// 		}
// 	}
...
// 	// Archive
// 	if ( isset( $theme_options['archive-post-content-layout'] ) ) {
// 		$post_types = Astra_Posts_Structure_Loader::get_supported_post_types();
// 		foreach( $post_types as $index => $post_type ) {
// 			$old_layout = $theme_options['archive-' . esc_attr($post_type) . '-content-layout'];
// 			switch ( $old_layout ) {
// 				case 'boxed-container':
// 					$theme_options['archive-' . esc_attr($post_type) . '-new-content-layout'] = 'normal-width-container';
// 					$theme_options['archive-' . esc_attr($post_type) . '-content-style']      = 'boxed';
// 					break;
// 				case 'content-boxed-container':
// 					$theme_options['archive-' . esc_attr($post_type) . '-new-content-layout'] = 'normal-width-container';
// 					$theme_options['archive-' . esc_attr($post_type) . '-content-style']      = 'boxed';
...
// 				case 'plain-container':
// 					$theme_options['archive-' . esc_attr($post_type) . '-new-content-layout'] = 'normal-width-container';
// 					$theme_options['archive-' . esc_attr($post_type) . '-content-style']      = 'unboxed';
// 					break;
// 				case 'page-builder':
// 					$theme_options['archive-' . esc_attr($post_type) . '-new-content-layout'] = 'full-width-container';
// 					$theme_options['archive-' . esc_attr($post_type) . '-content-style']      = 'unboxed';
// 					break;
// 				case 'narrow-container':
// 					$theme_options['archive-' . esc_attr($post_type) . '-new-content-layout'] = 'narrow-width-container';
// 					$theme_options['archive-' . esc_attr($post_type) . '-content-style']      = 'unboxed';
// 					break;
// 				default:
// 					break;
