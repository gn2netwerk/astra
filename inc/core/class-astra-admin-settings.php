			...
			if ( current_user_can( 'install_plugins' ) && ! defined( 'ASTRA_SITES_NAME' ) && '1' == get_option( 'fresh_site' ) && ! in_array( $current_slug, array( 'astra-advanced-hook', 'astra_adv_header' ), true ) ) {
				...
				$astra_sites_notice_args = array(
					...
					'message'                    => sprintf(
						...
						__( 'Did you know Astra comes with dozens of ready-to-use <a href="https://wpastra.com/starter-templates/?utm_source=dashboard&utm_medium=free-theme&utm_campaign=starter-templates" target="_blank">starter templates</a>? Install the Starter Templates plugin to get started.', 'astra' ),
