	...
	class Astra_Lifter_Container_Configs extends Astra_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'              => ASTRA_THEME_SETTINGS . '[lifterlms-new-content-layout]',
					'type'              => 'control',
					'control'           => 'ast-radio-image',
					'sanitize_callback' => array( 'Astra_Customizer_Sanitizes', 'sanitize_choices' ),
					'section'           => $section,
					'default'           => astra_get_option( 'lifterlms-new-content-layout' ),
					'priority'          => 1,
					...
					'divider'           => array( 'ast_class' => 'ast-bottom-spacing ast-bottom-divider ast-section-spacing' ),
				),
